...
export const loanProviders: LoanProvider[] = [
  ...
  },
  {
    id: 'kredittlanet',
    name: 'Kredittlånet',
    programId: 1870436470,
    adId: 1870436474,
    logoUrl: 'https://adtraction.com/image.htm?imgId=1870436469',
    url: 'https://kredittlanet.no',
    epc: 37.50,
    commissions: [{ name: 'Konvertering', value: 2250, type: 'NOK' }],
    minAmount: 5000,
    maxAmount: 500000,
    ...
    loanType: 'unsecured',
    acceptsPaymentRemarks: false,
    description: 'Kredittlånet tilbyr forbrukslån uten sikkerhet med rask behandling og fleksible nedbetalingsvilkår.',
    features: ['Lån uten sikkerhet', 'Rask behandling', 'Fleksibel nedbetaling', 'Ingen gebyrer'],
    rating: 4.0,
  },
  {
    id: 'lanerad',
    name: 'Låneråd',
    programId: 1870436009,
    adId: 1870436013,
    logoUrl: 'https://adtraction.com/image.htm?imgId=1870436008',
    url: 'https://lanerad.no',
    epc: 37.42,
    commissions: [{ name: 'CPO', value: 1030, type: 'NOK' }],
    minAmount: 10000,
    maxAmount: 600000,
    minRate: 7.9,
    maxRate: 22.0,
    ...
    loanType: 'broker',
    acceptsPaymentRemarks: false,
    description: 'Låneråd hjelper deg å finne det beste forbrukslånet ved å sammenligne tilbud fra flere banker.',
    features: ['Gratis tjeneste', 'Sammenligner banker', 'Personlig rådgivning', 'Raskt svar'],
    rating: 4.1,
  },
  {
    id: 'viiga',
    name: 'Viiga Lån',
    programId: 1492826547,
    adId: 1492826551,
    logoUrl: 'https://adtraction.com/image.htm?imgId=1492826546',
    url: 'https://viiga.no',
    epc: 37.50,
    commissions: [{ name: 'Konvertering', value: 2250, type: 'NOK' }],
    minAmount: 5000,
    ...
    loanType: 'unsecured',
    acceptsPaymentRemarks: false,
    description: 'Viiga Lån tilbyr forbrukslån uten sikkerhet med konkurransedyktige renter og rask saksbehandling.',
    features: ['Lån uten sikkerhet', 'Konkurransedyktige renter', 'Rask saksbehandling', 'Fleksibel nedbetaling'],
    rating: 4.0,
  },
  {
    id: 'morrow',
    name: 'Morrow Bank',
    programId: 1746519958,
    adId: 1746519962,
    logoUrl: 'https://adtraction.com/image.htm?imgId=1746519957',
    url: 'https://morrowbank.no',
    epc: 45.0,
    commissions: [{ name: 'Lead', value: 1800, type: 'NOK' }],
    minAmount: 10000,
    maxAmount: 500000,
    minRate: 8.5,
    maxRate: 20.0,
    ...
    loanType: 'unsecured',
    acceptsPaymentRemarks: true,
    description: 'Morrow Bank tilbyr forbrukslån med fokus på digital opplevelse og rask utbetaling.',
    features: ['Heldigital opplevelse', 'Rask utbetaling', 'Fleksibel nedbetaling', 'Ingen skjulte gebyrer'],
    rating: 4.2,
  },
  {
    id: 'paymark',
    name: 'Paymark Finans',
    programId: 1330052843,
    adId: 1330052847,
    logoUrl: 'https://adtraction.com/image.htm?imgId=1330052842',
    url: 'https://paymarkfinans.no',
    epc: 28.0,
    commissions: [{ name: 'Konvertering', value: 2250, type: 'NOK' }],
    minAmount: 10000,
    maxAmount: 500000,
    ...
    loanType: 'unsecured',
    acceptsPaymentRemarks: false,
    description: 'Paymark Finans tilbyr forbrukslån uten sikkerhet med konkurransedyktige betingelser og rask behandling.',
    features: ['Lån uten sikkerhet', 'Konkurransedyktige betingelser', 'Rask behandling', 'Ingen søknadsgebyr'],
    rating: 3.9,
  },
]
