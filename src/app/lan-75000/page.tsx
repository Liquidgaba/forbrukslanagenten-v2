...
export const metadata: Metadata = {
  title: 'Lån 75 000 kr | Beste forbrukslån 2026 — Sammenlign renter',
  description: 'Trenger du å låne 75 000 kroner? Sammenlign de beste forbrukslånene. Renter fra 5,9%, svartid 1-2 dager. Søk gratis hos flere banker samtidig.',
  alternates: { canonical: 'https://xn--forbrukslnagenten-hrb.no/lan-75000' },
}

const AMOUNT = 75000
const MONTHLY_3Y = Math.round(AMOUNT * 1.15 / 36) // ~2,396 kr
const MONTHLY_5Y = Math.round(AMOUNT * 1.25 / 60) // ~1,563 kr
...
const faqs = [
  ...
  { q: 'Hvem kan få lån på 75 000 kr?', a: 'Du må være over 18 år, ha fast inntekt (minimum ca. 200 000–250 000 kr/år), og være folkeregistrert i Norge. De fleste banker krever også at du ikke har betalingsanmerkninger.' },
...
export default function Lan75000() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <Breadcrumb items={[{ name: 'Lån 75 000 kr' }]} />
      ...
      <div className="prose prose-lg max-w-none mt-8 mb-8">
        ...
        <p>De fleste norske banker har 50 000–600 000 kr som standard låneområde for usikrede forbrukslån. Blant våre samarbeidspartnere finner du:</p>
        <ul>
        ...
        <ul>
          ...
          <li>Slutten på boligkjøp (kjøpsomkostninger)</li>
        </ul>
        ...
        <p>Har du allerede lån med høy rente? {AMOUNT.toLocaleString('no-NO')} kr kan være perfekt for å <Link href={"/refinansiering-uten-sikkerhet"}>samle gjeld</Link> og få bedre vilkår. Du kan spare 15 000–30 000 kroner i rente over lånets løpetid.</p>
      </div>
      ...
      <InternalLinks exclude="/lan-75000" />
    </div>
  )
}
